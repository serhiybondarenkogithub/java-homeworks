...
public class WomanTest {
    Man simpleFather;
    Woman simpleMother;
    homework7.entities.family.Family simpleFamily;
    Woman karen;
    Man hank;
    homework7.entities.family.Family moodies;
    Set<Pet> pets;
    ...
    void setUp() {
        ...
        simpleFamily = new homework7.entities.family.Family(simpleMother, simpleFather);
        pets = new HashSet<>();
